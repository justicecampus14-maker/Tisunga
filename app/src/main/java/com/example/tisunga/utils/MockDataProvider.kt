...
object MockDataProvider {
    ...
    fun getMockLoans() = listOf(
        Loan(
            ...
            interestRate=65.0,
            interestRateLabel = "65%",
            totalRepayable=1072500.0,
            remainingBalance=536250.0,
            durationMonths=6,
            status="active",
        ...
        Loan(
            ...
            principalAmount=650000.0,
            interestRate=35.0,
            interestRateLabel = "35%",
            totalRepayable=877500.0,
            remainingBalance=438750.0,
            durationMonths=3,
            status="active",
            approverName="Laston Mzumala",
            approvedAt="Feb 01 2026",
    ...
    fun getMockPendingLoans() = listOf(
        Loan(
            ...
            principalAmount=650000.0,
            interestRate=25.0,
            interestRateLabel = "25%",
            totalRepayable=812500.0,
    ...
    fun getMockTransactions() = listOf(
        ...
        Transaction(
            ...
            description="Loan application of Chikondi Phiri has been approved By the Chair Tiyamike Tobias. Loan Amount: MK 20,000. Duration: 2 Months. Interest: MK 5,000. Group Balance: 50,000",
